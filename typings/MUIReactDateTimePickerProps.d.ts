/**
 * This file was generated from MUIReactDateTimePicker.xml
...
export interface MUIReactDateTimePickerContainerProps {
    name: string;
    tabIndex?: number;
    id: string;
...
export interface MUIReactDateTimePickerPreviewProps {
    readOnly: boolean;
